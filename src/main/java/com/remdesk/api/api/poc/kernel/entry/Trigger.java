...
import com.remdesk.api.api.poc.annotation.CreateTrigger;
import com.remdesk.api.api.poc.annotation.DeleteTrigger;
import com.remdesk.api.api.poc.annotation.UnmanagedTrigger;
import com.remdesk.api.api.poc.annotation.UpdateTrigger;
...
public class Trigger {
    ...
    protected void handleCreateTrigger( Request request, TriggerHandler.Trigger targetTrigger, com.remdesk.api.api.poc.annotation.Trigger trigger, Object lastSubject )
            throws Throwable {
    ...
    protected void handleUpdateTrigger( Request request, TriggerHandler.Trigger targetTrigger, com.remdesk.api.api.poc.annotation.Trigger trigger, Object lastSubject )
            throws Throwable {
    ...
    protected void handleDeleteTrigger( Request request, TriggerHandler.Trigger targetTrigger, com.remdesk.api.api.poc.annotation.Trigger trigger, Object lastSubject )
            throws Throwable {
    ...
    protected void handleUnmanagedTrigger( Request request, TriggerHandler.Trigger targetTrigger, com.remdesk.api.api.poc.annotation.Trigger trigger, Object lastSubject )
            throws Throwable {

        if ( trigger.provideMe() ) {
            (( com.remdesk.api.api.poc.api.UnmanagedTrigger ) targetTrigger.getExecutor()).handle( request, lastSubject );
        ...
        if ( !trigger.providerField().isBlank() ) {
            ...
            if ( field.getType().isArray() || field.getType().isAssignableFrom( Collection.class ) ) {
                ...
                for ( Object entity : entities ) {
                    (( com.remdesk.api.api.poc.api.UnmanagedTrigger ) targetTrigger.getExecutor()).handle( request, entity );
    ...
    protected void handleTriggers( Request request, List< com.remdesk.api.api.poc.annotation.Trigger > triggers, Object lastSubject ) throws Throwable {
        for ( com.remdesk.api.api.poc.annotation.Trigger trigger : triggers ) {
