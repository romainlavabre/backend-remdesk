    ...
    public static class Setter {
        ...
        private void compute()
            ...
            if ( requestParameter != null ) {
                ...
                if ( !isRelation ) {
                    this.requestParameter = com.remdesk.api.api.poc.kernel.util.Formatter.toSnakeCase( field.getDeclaringClass().getSimpleName() + "_" + field.getName() );
                } else {
                    this.requestParameter = com.remdesk.api.api.poc.kernel.util.Formatter.toSnakeCase( field.getDeclaringClass().getSimpleName() + "_" + field.getName() + "_id" );
                }
            }
        ...
        protected Method searchSetter()
            ...
            com.remdesk.api.api.poc.annotation.Setter setter = field.getAnnotation( com.remdesk.api.api.poc.annotation.Setter.class );
            ...
            if ( isArrayOrCollection ) {
                searchs.add( "add" + com.remdesk.api.api.poc.kernel.util.Formatter.toPascalCase( field.getName() ).replaceFirst( "s$", "" ) );
                searchs.add( "add" + com.remdesk.api.api.poc.kernel.util.Formatter.toPascalCase( field.getName() ) );
            } else {
