package com.remdesk.api.api.poc.kernel.trigger;
...
public class TriggerHandler {
    ...
    public class Trigger {
        ...
        private final List< com.remdesk.api.api.poc.annotation.Trigger > triggers;
        ...
        public List< com.remdesk.api.api.poc.annotation.Trigger > getTriggers() {
            return triggers;
        }
