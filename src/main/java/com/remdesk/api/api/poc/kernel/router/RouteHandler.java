...
import com.remdesk.api.configuration.security.Role;
...
public class RouteHandler {
    ...
    public List< Route > toRoute( Class< ? > subject, Field field ) throws SetterNotFoundException, ToManySetterParameterException, MultipleSetterFoundException, InvalidSetterParameterType, NoSuchFieldException, NoSuchMethodException {
        ...
        String id = com.remdesk.api.api.poc.kernel.util.Formatter.toSnakeCase( subject.getSimpleName() ) + entityHandler.getEntity( field.getDeclaringClass() ).getSuffixPlural() + "::" + field.getName();
    ...
    public class Route {
        ...
        public String getRepositoryMethod() {
            if ( httpType instanceof GetOneBy ) {
                ...
                return "findOrFailBy" + com.remdesk.api.api.poc.kernel.util.Formatter.toPascalCase( (( GetOneBy ) httpType).entity().getSimpleName() );
            }
        ...
        private String getRoute( String route, Object annotation, Field field ) {
            ...
            if ( annotation instanceof GetOne
                ...
                stringJoiner
                        .add( "by" )
                        .add( com.remdesk.api.api.poc.kernel.util.Formatter.toSnakeCase( (( GetOneBy ) annotation).entity().getSimpleName() ) )
                        .add( "{id:[0-9]+}" );
            } else if ( annotation instanceof GetAllBy ) {
                stringJoiner
                        .add( "by" )
                        .add( com.remdesk.api.api.poc.kernel.util.Formatter.toSnakeCase( (( GetAllBy ) annotation).entity().getSimpleName() ) )
                        .add( idPart );
            } else if ( annotation instanceof Patch ) {
                stringJoiner
                        .add( idPart )
                        .add( com.remdesk.api.api.poc.kernel.util.Formatter.toSnakeCase( field.getName() ) );
            }
